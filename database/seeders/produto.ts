    ...
    const produtos = [
      {
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/clb-commander-legends--battle-for-baldurs-gate/pt/med/magos-de-thay-105.png?5669',
      ...
      },
      {
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/lcc-the-lost-caverns-of-ixalan-commander/PT/med/templo-do-misterio-357.png?8123',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 3,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/dprp-duelist-pack-rivals-of-the-pharaoh/en/med/temple-of-the-kings-en037.png?2123?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 4,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/arb-alara-reborn/pt/med/assassino-de-mago-57.png?5385?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 5,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/dmc-dominaria-united-commander/pt/med/templo-do-triunfo-238.png?2429?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 6,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/w16-welcome-deck-2016/pt/med/esfinge-de-magosi-6.png?2554?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 7,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/onc-phyrexia-all-will-be-one-commander/pt/med/templo-da-enfermidade-169.png?3323?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 8,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/rvr-ravnica-remastered/PT/med/copia-de-encantamento-312.png?4898?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 9,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/lcc-the-lost-caverns-of-ixalan-commander/PT/med/templo-do-silencio-358.png?8709?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 10,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/onc-phyrexia-all-will-be-one-commander/pt/med/templo-da-enfermidade-169.png?3323',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 11,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/mkm-murders-at-karlov-manor/PT/med/sala-de-visitas-elegante-260.png?6383?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 12,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/mkm-murders-at-karlov-manor/PT/med/linha-de-forca-do-pacto-das-guildas-217.png?8690?&width=250',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 13,
        ...
        url_imagem: 'https://cdn.cardsrealm.com/images/cartas/lci-the-lost-caverns-of-ixalan/PT/back/ojer-axonil-forca-profunda-templo-do-poder-158.png?840',
        categoria_id: categoriaIds[Math.floor(Math.random() * categoriaIds.length)],
      },
      {
        id: 14,
